 ...
 * @author Mahmoud
 */
public class Photogragher implements PhotogragherInterface,Serializable{
    ...
    public Photogragher(String firstName, String secondName, double account,double percent , int id) throws RemoteException{
